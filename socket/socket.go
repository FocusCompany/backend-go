...
func InitSocket() error {
	...
	if err != nil {
		return errors.New("failed to create frontend" + err.Error())
	}
	...
	if err == nil {
		...
		return errors.New("failed to set frontend curve" + err.Error())
	}
	...
	if err != nil {
		return errors.New("failed to bind frontend" + err.Error())
	}
